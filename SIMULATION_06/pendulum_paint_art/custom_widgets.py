#!/usr/bin/env python3
"""
Custom Widgets for Pendulum Paint Art Control Panel
=====================================================
...
from PySide6.QtWidgets import (
    ...
    QVBoxLayout, QHBoxLayout, QDialog, QColorDialog
)
...
class ToggleSwitch(QCheckBox):
    ...
    def paintEvent(self, event):
        ...
        if self.isChecked():
            bg_color = QColor(224, 123, 83)  # Terracotta accent
            border_color = QColor(194, 93, 53)
        else:
            bg_color = QColor(55, 65, 81)
...
class ColorPickerButton(QPushButton):
    ...
    def __init__(self, initial_color="#2c1810", parent=None):
        super().__init__(parent)
    ...
    def _pick_color(self):
        ...
        color = QColorDialog.getColor(self.color, self, "Select Paint Color")
        if color.isValid():
            self.color = color
            self._update_button()
